...
urlpatterns = [
    ...
    path('pipelines/edit/<str:type>/<str:id>/<str:launch>/<str:data>', views.pipeline_edit_inputs,
         name="pipeline_edit_inputs"),
    path('pipelines/editEdge/<str:source>/<str:target>/<str:id>', views.pipeline_edit_edge_inputs,
         name="pipeline_edit_edge_inputs"),
